...
execute if entity @s[nbt={ActiveEffects:[{Id:30b}],Inventory:[{Slot:100b,tag:{Enchantments:[{id:"minecraft:depth_strider"}]}}]}] at @s if block ~ ~-1 ~ water run scoreboard players remove @s dive 2

execute if entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:elytra"}]}] run scoreboard players set @s fly -500

execute if entity @s[scores={run=15..},nbt={ActiveEffects:[{Amplifier:1b,Id:1b}]}] run scoreboard players remove @s run 15
execute if entity @s[scores={walk=15..},nbt={ActiveEffects:[{Amplifier:1b,Id:1b}]}] run scoreboard players remove @s walk 15
execute if entity @s[scores={run=20..},nbt={ActiveEffects:[{Amplifier:2b,Id:1b}]}] run scoreboard players remove @s run 20
execute if entity @s[scores={walk=20..},nbt={ActiveEffects:[{Amplifier:2b,Id:1b}]}] run scoreboard players remove @s walk 20
