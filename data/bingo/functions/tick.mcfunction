...
tellraw @a[tag=bingo,scores={Bingo=1..}] [{"text":"","clickEvent":{"action":"run_command","value":"/trigger Bingo"}},{"text":"[","color":"gray"},{"text":"Bingo","color":"yellow"},{"text":"] ","color":"gray"},{"text":"Current bingo items:\n- ","color":"yellow"},{"storage":"bingo:data","nbt":"current[].name","separator":{"text":"\n- ","color":"yellow"},"color":"green"}]
