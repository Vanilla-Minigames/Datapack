...
execute if score #found temp >= #bingototal value at @s[tag=bingored] run tellraw @a[distance=0..] [{"text":"[","color":"gray"},{"text":"Bingo","color":"yellow"},{"text":"] "},{"text":"Team ","color":"aqua"},{"text":"Red","color":"red"},{"text":" got all ","color":"aqua"},{"score":{"name":"#bingototal","objective":"value"},"color":"green"},{"text":" items and won the game!","color":"aqua"}]
execute if score #found temp >= #bingototal value at @s[tag=bingoblue] run tellraw @a[distance=0..] [{"text":"[","color":"gray"},{"text":"Bingo","color":"yellow"},{"text":"] "},{"text":"Team ","color":"aqua"},{"text":"Blue","color":"blue"},{"text":" got all ","color":"aqua"},{"score":{"name":"#bingototal","objective":"value"},"color":"green"},{"text":" items and won the game!","color":"aqua"}]
execute if score #found temp >= #bingototal value at @s[tag=bingoyellow] run tellraw @a[distance=0..] [{"text":"[","color":"gray"},{"text":"Bingo","color":"yellow"},{"text":"] "},{"text":"Team ","color":"aqua"},{"text":"Yellow","color":"yellow"},{"text":" got all ","color":"aqua"},{"score":{"name":"#bingototal","objective":"value"},"color":"green"},{"text":" items and won the game!","color":"aqua"}]
execute if score #found temp >= #bingototal value at @s[tag=bingogreen] run tellraw @a[distance=0..] [{"text":"[","color":"gray"},{"text":"Bingo","color":"yellow"},{"text":"] "},{"text":"Team ","color":"aqua"},{"text":"Green","color":"green"},{"text":" got all ","color":"aqua"},{"score":{"name":"#bingototal","objective":"value"},"color":"green"},{"text":" items and won the game!","color":"aqua"}]
execute if score #found temp >= #bingototal value at @s run scoreboard players set @a[distance=0..] l 1
