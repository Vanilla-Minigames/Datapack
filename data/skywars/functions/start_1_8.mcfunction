...
execute if score #skywarsmap temp matches 1 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"DomBuilder","color":"gold"}]
...
execute if score #skywarsmap temp matches 2 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"Nightshade_09 & LULL1","color":"gold"}]
...
execute if score #skywarsmap temp matches 3 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"Tim07iju","color":"gold"}]
...
execute if score #skywarsmap temp matches 4 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"Koljav","color":"gold"}]
...
execute if score #skywarsmap temp matches 5 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"KOMC","color":"gold"}]
...
execute if score #skywarsmap temp matches 6 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"kociaczek327","color":"gold"}]
...
execute if score #skywarsmap temp matches 7 run tellraw @a[tag=skywarswait_1_8] [{"text":"[","color":"gray"},{"text":"SkyWars","color":"yellow"},{"text":"] "},{"text":"Map built by: ","color":"aqua"},{"text":"Gechillter","color":"gold"}]
...
scoreboard players add @a[tag=skywarswait_1_8] skywarsgames 1
