...
scoreboard objectives add bedwarsbreakred minecraft.mined:minecraft.red_bed
scoreboard objectives add bedwarsbreakblue minecraft.mined:minecraft.blue_bed
scoreboard objectives add bedwarsbreakyellow minecraft.mined:minecraft.yellow_bed
scoreboard objectives add bedwarsbreakgreen minecraft.mined:minecraft.lime_bed
scoreboard objectives add bedwarscraftironingot minecraft.crafted:minecraft.iron_ingot
